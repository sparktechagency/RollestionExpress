...
// const ProfileMenuItem = ({ icon, label, hasToggle, onToggle, toggleValue, linkup }: { icon: React.ReactNode; label: string; hasToggle?: boolean; onToggle?: (value: boolean) => void; toggleValue?: boolean; linkup?: any; }) => (
//     <TouchableOpacity onPress={() => {
//         if (linkup) {
//             router.push(linkup);
//         } else {
//             console.warn(`${label} has no link defined.`);
//         }
...
//     const menuItems = [
//         { icon: <PaymentIcon style={tw`text-blue-400`} />, label: 'Payment Methods', linkup: '/(screens)/paymentmethod' },
//         { icon: <HistoryIcon style={tw`text-blue-400`} />, label: 'Trip History', linkup: '/(screens)/triphistory' },
//         { icon: <AutoTopUpIcon style={tw`text-blue-400`} />, label: 'Auto Top-Up', hasToggle: true, onToggle: setAutoTopUp, toggleValue: autoTopUp },
//         { icon: <CloseAccountIcon style={tw`text-blue-400`} />, label: 'Close Account' },
//         { icon: <ContactIcon style={tw`text-blue-400`} />, label: 'Contact Us', linkup: '/(screens)/contact' },
//         { icon: <LogoutIcon style={tw`text-blue-400`} />, label: 'Log Out', noBorder: true },
//     ];
